...
const sidebar = [
  ...
  { value: "Motivation and Goals", id: "4" },
...
Anirudh Singh .......... use this format`);
  ...
  const [studentData10, setStudentData10] = useState({
    ...
    stu_academicDetails_subjects: "Data Structures, Algorithms, Machine Learning",
    stu_academicDetails_awards: "Dean's List, Best Project Award 2022",
    stu_academicDetails_research_exp: "Research Assistant in AI for two semesters.",
    stu_job_details: [
        {
            stu_company_name: "Tech Solutions",
            stu_job_title: "Software Intern",
            stu_job_duration: "3 months",
            stu_role_description: "Worked on developing web applications using React and Node.js."
        }
    ],
    stu_internship_details: [
        {
            ...
            stu_in_role_description: "Assisted in building predictive models using Python."
        }
    ],
    stu_professional_achievements: "Successfully led a team project that won first place in a hackathon.",
    ...
    stu_why_choose_program: "I am passionate about AI and believe this program will equip me with advanced skills.",
    stu_short_term_goals: "To enhance my programming skills and gain practical experience.",
    stu_long_term_goals: "To become a leading AI researcher.",
    stu_why_this_uni: "The University of Toronto is renowned for its research facilities and faculty in AI.",
    stu_research_interests: "Deep Learning, Natural Language Processing.",
    stu_prog_align_goals: "This program aligns perfectly with my career aspirations.",
    stu_growth_development: "I aim to grow as a professional and contribute to impactful projects.",
    stu_extracurricular_involvement: "Member of the coding club and volunteer for local NGOs.",
    stu_leadership_roles: "Led a team project in college to develop a mobile app.",
    stu_community_service: "Volunteered at a local orphanage teaching computer skills.",
    stu_hobbies: "Reading, coding, and playing chess.",
    stu_personal_challenges: "Overcame difficulties with public speaking through practice and workshops.",
    stu_learning_from_mistakes: "Learned to manage time better after missing a project deadline.",
    stu_additional_points_highlight: "Completed an online course on AI fundamentals.",
  ...
  const handleSubmit = () => {
    ...
    studentData.stu_languages_spoken = selectedLang?.map((item) => item).join(",");setRes("");
    studentData.stu_focus_areas = selectedFoucsArea?.map((item) => item).join(",");
  ...
  const deleteInternshipDetail = (id) => {
    ...
    setStudentData((prevData) => ({
      ...prevData,
      stu_internship_details: prevData.stu_internship_details.filter((job) => job.id !== id),
    }));
  };
...
<div className="two-fields">
                ...
                {selectedOption === "3" && (
                  <div className="form-module-wrapper-v-2 step-1">
                    <div className={studentData.stu_job_details.length > 0 && `work-exp-box`}>
                    <div className="two-fields">
                      <div
                    ...
                    <div className="pb-2 margin-right-16">
                      {studentData.stu_job_details.map((job, jobIndex) => (
                        <div key={job.id} className="d-flex">
                          <div className={`input-field-wrapper mar_right w-50`}>
                            <input
                              type="text"
                    ...
                    <div className={studentData.stu_internship_details.length > 0 && `work-exp-box`}>
                    <div className="two-fields">
                      <div
                        className="input-field mar_right d-flex justify-content-between"
                        onClick={() => {
                    ...
                    <div className="pb-2 margin-right-16">
                      {studentData.stu_internship_details.map((job, jobIndex) => (
                        <div key={job.id} className="d-flex">
                          <div className={`input-field-wrapper mar_right w-50`}>
                            <input
                              type="text"
                              ...
                              onChange={(e) => {
                                ...
                                updatedJobDetails[jobIndex].stu_in_company_name =
                                  e.target.value;
                                setStudentData({
                                  ...studentData,
                          ...
                          <div className={`input-field-wrapper mar_right w-50`}>
                            <input
                              ...
                              onChange={(e) => {
                                ...
                                updatedJobDetails[jobIndex].stu_in_job_title =
                                  e.target.value;
                                setStudentData({
                                  ...studentData,
                                  stu_internship_details: updatedJobDetails,
                          ...
                          <div className={`input-field-wrapper mar_right`}>
                            <input
                              ...
                              onChange={(e) => {
                                ...
                                updatedJobDetails[jobIndex].stu_in_job_duration =
                                  e.target.value;
                                setStudentData({
                                  ...studentData,
                                  stu_internship_details: updatedJobDetails,
