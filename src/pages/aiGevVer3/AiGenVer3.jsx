...
Anirudh Singh .......... use this format only , not this data`);
  ...
  const [studentData, setStudentData] = useState({
    ...
    // ############### step5 ###############
    stu_extracurricular_involvement: false,
    stu_leadership_roles: "",
    stu_community_service: false,
    stu_hobbies: "",
...
<CheckboxField
                      ...
                      studentData={studentData}
                      setStudentData={setStudentData}
                      stu_data_obj_key={studentData.stu_extracurricular_involvement}
                      stu_data_obj="stu_extracurricular_involvement"
                    />

                    <CheckboxField
                      content={`Community Service/Volunteering`}
                      studentData={studentData}
                      setStudentData={setStudentData}
